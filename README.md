The repo contains two branches, one used only for rendering the original figures (original_figures_rendering) and the other (main) contains the main branch we worked off.
